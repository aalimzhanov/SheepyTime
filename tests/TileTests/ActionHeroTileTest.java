...
public class ActionHeroTileTest {
    ...
    public void testActivateEffectConsumesZZZForScaredPlayerNoInfiniteZZZs() {
        ...
        assertTrue("ZZZs should decrease by 1 for scared player without infinite ZZZs", initialZZZs - 1 == scaredPlayerNoInfiniteZZZs.getNumOfZzzs());
    }
